...
MESAFLASH_GIT = ~seb/mesaflash.git
MESAFLASH_BRANCH = prep-for-release

ALL_MESAFLASH_DSCS = $(foreach DIST,unstable testing bullseye buster stretch jessie wheezy precise,stamps/$(DIST)/mesaflash.dsc)

ALL_MESAFLASH_DEBS = $(foreach DIST,unstable testing bullseye buster stretch jessie wheezy precise,\
    $(foreach ARCH,i386 amd64,\
...
TESTING_KEY_ID = 0E98404D386FA1D9
BULLSEYE_KEY_ID = 605C66F00D6C9793
BUSTER_KEY_ID = DCC9EFBF77E11517
STRETCH_KEY_ID = EF0F382A1A7B6500
JESSIE_KEY_ID = CBF8D6FD518E17E1
WHEEZY_KEY_ID = 6FB2A1C265FFB764
UBUNTU_KEY_ID = 40976EAF437D05B5
KEY_IDS = $(TESTING_KEY_ID) $(BULLSEYE_KEY_ID) $(BUSTER_KEY_ID) $(STRETCH_KEY_ID) $(JESSIE_KEY_ID) $(WHEEZY_KEY_ID) $(UBUNTU_KEY_ID)
